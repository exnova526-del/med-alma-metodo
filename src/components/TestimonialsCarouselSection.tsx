...
const TestimonialsCarouselSection = () => {
  ...
  const carouselParallax = useParallax(carouselRef, { speed: 0.3, direction: 'up' });
      ...
      <div className="container px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="font-playfair text-3xl sm:text-4xl md:text-5xl font-bold text-darkBrown mb-6">
              ...
              {testimonialImages.map((_, index) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all duration-300 ${
                    index === current
                      ? "w-8 bg-accent"
                      : "w-2 bg-darkBrown/30 hover:bg-darkBrown/50"
                  }`}
